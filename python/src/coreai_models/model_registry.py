...
LLM_PRESETS: list[ModelPreset] = [
    ...
    ModelPreset(
        ...
        "float16",
        4096,
        notes="Uses the dedicated Phi-3 Core AI adapter; LongRoPE checkpoints require a shorter/default-RoPE export.",
    ),
    ModelPreset(
        "phi-3.5-mini-instruct",
        "microsoft/Phi-3.5-mini-instruct",
        ...
        "float16",
        4096,
        notes="iOS export uses the 4096-token short-context RoPE branch.",
    ),
    ModelPreset(
